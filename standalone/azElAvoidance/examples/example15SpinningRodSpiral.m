...
if plan.method ~= "reverseDijkstraForwardKinodynamicAStar" || ...
        ~plan.diagnostics.reverseDijkstra.executed || ...
        ~plan.diagnostics.forwardAStar.executed || ...
        isfield(plan.options, "GuidePath_deg") || ...
        isfield(plan.options, "DirectionAngles_deg")
    error("example15SpinningRodSpiral:ExternalGuideUsed", ...
        "The spinning-rod spiral must use the unguided unified planner.");
end
