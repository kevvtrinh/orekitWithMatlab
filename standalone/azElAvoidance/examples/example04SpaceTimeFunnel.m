function result = example04SpaceTimeFunnel(viewOptions)
%EXAMPLE04SPACETIMEFUNNEL Plan through two moving az/el/time volumes.
%
...
options = struct( ...
    ...
    "KinodynamicTimeStep_s", 2, ...
    "KinodynamicGridStep_deg", 1, ...
    "CorridorRadiusSchedule_deg", [2 4], ...
...
if ~plan.success
    error("example04SpaceTimeFunnel:NoPath", ...
...
if any(blocked)
    error("example04SpaceTimeFunnel:Collision", ...
...
result = struct( ...
    ...
    "view", view);
fprintf(['Space-time funnel: %.3f deg, %.3f s search, ' ...
    '%d expansions, %s.\n'], ...
