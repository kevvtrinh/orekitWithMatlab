...
while heapCount > 0
    ...
    for transitionIndex = 1:transitionCount
        ...
        collisionCacheEligible = ~isempty(staticEdgeCollisionStatus) && ...
            transitionDistance_deg > 0 && canUseCachedPrimitive;
        if collisionCacheEligible && staticEdgeCollisionStatus( ...
                currentCellId, transitionIndex) ~= 0
            collisionFree = staticEdgeCollisionStatus( ...
                currentCellId, transitionIndex) > 0;
            counters.cacheHits = counters.cacheHits + 1;
        else
            if collisionCacheEligible
...
[boundaryPosition_deg, boundaryVelocity_deg_s, ...
    ...
    firstPosition_deg, firstVelocity_deg_s, firstAcceleration_deg_s2, ...
    secondPosition_deg, secondVelocity_deg_s, ...
    secondAcceleration_deg_s2, duration_s, boundaryTime_s);
...
for obstacleIndex = 1:numel(obstacleModel)
    ...
    obstacleIsRelevant(obstacleIndex) = ...
        timeOverlaps && elevationOverlaps && azimuthOverlaps;
end
