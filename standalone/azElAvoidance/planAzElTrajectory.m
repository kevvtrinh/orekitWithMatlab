...
for candidateIndex = 1:numel(candidates)
    ...
    if isempty(staticObstacleModel)
        goalSeedCost(candidateSeedIds) = 0;
        continue;
    end
    ...
    for seedIndex = 1:numel(candidateSeedIds)
        ...
        if staticLineCollisionFree( ...
            ...
            goalSeedCost(cellId) = 0;
        end
    end
end
goalCellIds = find(isfinite(goalSeedCost));
if isempty(goalCellIds)
    maximumGoalSeedCost = NaN;
else
    maximumGoalSeedCost = max(goalSeedCost(goalCellIds));
end
...
diagnostics = struct( ...
    ...
    "maximumGoalSeedCost", maximumGoalSeedCost, ...
