...
options = struct( ...
    ...
    "GuidePrimitiveRadii_deg", [0.5 1 2 4], ...
    "GuideDirectionAngles_deg", 180, ...
    "GuideHeuristicWeight", 1.5, ...
    "GuideCollisionCheckStep_s", 0.1, ...
    "MaximumDepartureTrials", 32, ...
    "DepartureBatchSize", 4, ...
    "GuideMaxExpansions", 150000, ...
    "GuideMaxWallTime_s", 30, ...
    "SafetyMargin_deg", 0.08, ...
