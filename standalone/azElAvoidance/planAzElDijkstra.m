...
% Both path-based attempts check their timed command against every moving
% obstacle before returning it.
...
elseif any(motionModeName == ["pathstatespacekinematic", ...
    ...
    error("planAzElDijkstra:InvalidMotionMode", ...
        ["MotionMode must be profile, pathFirstThenKinematic, or " ...
        "pathStateSpaceKinematic."]);
end
