function result = exampleGauntlet02StopGoStopGo()
%EXAMPLEGAUNTLET02STOPGOSTOPGO Pass three sequentially opening gates.
...
if result.diagnostics.waitingEpisodeCount < 3
    error("exampleGauntlet02StopGoStopGo:TooFewStops", ...
...
if any(waitedAfterFinalGate) || ...
    ...
    error("exampleGauntlet02StopGoStopGo:LateFinalSlew", ...
