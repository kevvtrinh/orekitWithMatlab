...
verifyEqual(testCase, ...
    plan.motionPlanning.ParetoRefinement.OptimizationMethod, ...
    "adaptivePiecewiseQuinticDirectCollocation");
verifyGreaterThanOrEqual(testCase, ...
    plan.motionPlanning.ParetoRefinement.CollocationKnotCount, 2);
verifyTrue(testCase, ...
    plan.motionPlanning.PhysicalVerificationAttempted);
verifyFalse(testCase, ...
    plan.motionPlanning.PhysicalVerificationSucceeded);
verifyFalse(testCase, ...
    plan.motionPlanning.PhysicalVerification.AnalyticJerkAvailable);
verifyPlan(testCase, plan);
end
...
verifyEqual(testCase, ...
    plannerDefaults.ParetoRefinementMaximumKnotCount, 401);
verifyEqual(testCase, ...
    plannerDefaults.ParetoRefinementCoordinatePassCount, 2);
verifyEqual(testCase, ...
    plannerDefaults.ParetoRefinementCandidateBudget, 48);
