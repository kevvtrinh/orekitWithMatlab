...
%% Plot the final 3-D az/el/time obstacle workspace
% The static view draws at most 100 representative slices. Every packed
% time slice remains available to the collision query even when not drawn.
obstacleView = plotAzElTimeObstacleWorkspace(obstacleWorkspace, struct( ...
